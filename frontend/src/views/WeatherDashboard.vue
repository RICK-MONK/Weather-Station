...
const metrics = computed(() => [
  {
    label: 'Temperature',
    value: weatherStore.formatValue('temperature', Number(latestRaw.value.temperature)),
  ...
  {
    label: 'Humidity',
    value: weatherStore.formatValue('humidity', Number(latestRaw.value.humidity)),
  ...
  {
    label: 'Heat Index',
    value: weatherStore.formatValue('heatIndex', Number(latestRaw.value.heatIndex)),
  ...
  },
  {
    ...
    value: weatherStore.formatValue('pressure', Number(latestRaw.value.pressure)),
  ...
  },
  {
    ...
    value: weatherStore.formatValue('altitude', Number(latestRaw.value.altitude)),
    caption: 'Derived from BMP280 pressure and the configured sea-level reference',
  ...
  {
    label: 'Soil Moisture',
    value: weatherStore.formatValue('soilMoisturePercent', Number(latestRaw.value.soilMoisturePercent), 0),
